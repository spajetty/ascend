...
export const programHeaders = {
    ...
    'Job Matching and Referral': ['Last Name', 'First Name', 'Middle Name', 'Suffix', 'Sex', 'House No.', 'Barangay', 'City', 'District', 'Birthday', 'Age', 'Email', 'Contact', 'Civil Status', 'Program', 'Classification', 'Company', 'Resume', 'B-Cert', 'Valid ID', 'Brgy Clearance'],
    'First Time Jobseeker': ['Last Name', 'First Name', 'Middle Name', 'Suffix', 'Sex', 'House No.', 'Barangay', 'City', 'District', 'Birthday', 'Age', 'Email', 'Contact', 'Civil Status', 'Program', 'Classification', 'Company', 'Resume', 'B-Cert', 'Valid ID', 'Brgy Clearance'],
    'Job Fair': ['Last Name', 'First Name', 'Middle Name', 'Suffix', 'Sex', 'House No.', 'Barangay', 'City', 'District', 'Birthday', 'Age', 'Email', 'Contact', 'Civil Status', 'Program', 'Classification', 'Position', 'Company', 'Resume', 'B-Cert', 'Valid ID', 'Brgy Clearance'],
