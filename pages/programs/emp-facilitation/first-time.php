    ...
    <div class="px-6 md:px-8 py-6">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm p-5 flex flex-col gap-2 border-l-4 border-orange-400">
                <div class="flex items-center justify-between">
                    <span class="text-2xl font-bold text-gray-800">285</span>
            ...
            <div class="bg-white rounded-2xl shadow-sm p-5 flex flex-col gap-2 border-l-4 border-blue-400">
                <div class="flex items-center justify-between">
                    <span class="text-2xl font-bold text-gray-800">394</span>
            ...
            <div class="bg-white rounded-2xl shadow-sm p-5 flex flex-col gap-2 border-l-4 border-purple-400">
                <div class="flex items-center justify-between">
                    <span class="text-2xl font-bold text-gray-800">106</span>
                ...
                <table class="w-full text-xs">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-50 hover:bg-gray-50">
                            ...
                            <!-- First-Time Jobseekers -->
                            <td class="px-3 py-2 text-center text-gray-600 border-l border-gray-100">24</td>
                            <td class="px-3 py-2 text-center text-gray-600">38</td>
                            <td class="px-3 py-2 text-center font-semibold text-teal-600 bg-teal-50">62</td>
                            <!-- Issued -->
                            <td class="px-3 py-2 text-center font-semibold text-pink-500 border-l border-gray-100">87</td>
                            <td class="px-3 py-2 text-center font-semibold text-green-500">112</td>
                            <!-- Interviewed -->
                            <td class="px-3 py-2 text-center text-gray-600 border-l border-gray-100">20</td>
                            <td class="px-3 py-2 text-center text-gray-600">32</td>
                            <td class="px-3 py-2 text-center font-semibold text-cyan-500 bg-cyan-50">52</td>
                            <!-- Qualified -->
                            <td class="px-3 py-2 text-center text-gray-600 border-l border-gray-100">16</td>
                            <td class="px-3 py-2 text-center text-gray-600">26</td>
                            <td class="px-3 py-2 text-center font-semibold text-green-500 bg-green-50">42</td>
                            <!-- Not Qualified -->
                            <td class="px-3 py-2 text-center text-gray-600 border-l border-gray-100">4</td>
                            <td class="px-3 py-2 text-center text-gray-600">6</td>
                            <td class="px-3 py-2 text-center font-semibold text-red-400 bg-red-50">10</td>
                            <!-- Placed / HOTS -->
                            <td class="px-3 py-2 text-center text-gray-600 border-l border-gray-100">13</td>
                            <td class="px-3 py-2 text-center text-gray-600">22</td>
                            <td class="px-3 py-2 text-center font-semibold text-orange-400 bg-orange-50">35</td>
                            <!-- For Further Interview -->
                        ...
                        <tr class="border-b border-gray-50 hover:bg-gray-50">
                            ...
                            <td class="px-3 py-2 text-center text-gray-600">29</td>
                            <td class="px-3 py-2 text-center font-semibold text-teal-600 bg-teal-50">47</td>
                            <td class="px-3 py-2 text-center font-semibold text-pink-500 border-l border-gray-100">95</td>
                            <td class="px-3 py-2 text-center font-semibold text-green-500">134</td>
                            <td class="px-3 py-2 text-center text-gray-600 border-l border-gray-100">15</td>
                            <td class="px-3 py-2 text-center text-gray-600">24</td>
                            ...
                            <td class="px-3 py-2 text-center text-gray-600">19</td>
                        ...
                        <tr class="border-b border-gray-50 hover:bg-gray-50">
                            ...
                            <td class="px-3 py-2 text-center text-gray-600 border-l border-gray-100">31</td>
                            <td class="px-3 py-2 text-center text-gray-600">44</td>
                            <td class="px-3 py-2 text-center font-semibold text-teal-600 bg-teal-50">75</td>
                            <td class="px-3 py-2 text-center font-semibold text-pink-500 border-l border-gray-100">103</td>
                            <td class="px-3 py-2 text-center font-semibold text-green-500">148</td>
                            <td class="px-3 py-2 text-center text-gray-600 border-l border-gray-100">26</td>
                            <td class="px-3 py-2 text-center text-gray-600">38</td>
                            <td class="px-3 py-2 text-center font-semibold text-cyan-500 bg-cyan-50">64</td>
                            <td class="px-3 py-2 text-center text-gray-600 border-l border-gray-100">21</td>
                            <td class="px-3 py-2 text-center text-gray-600">31</td>
                            <td class="px-3 py-2 text-center font-semibold text-green-500 bg-green-50">52</td>
                            <td class="px-3 py-2 text-center text-gray-600 border-l border-gray-100">5</td>
                            <td class="px-3 py-2 text-center text-gray-600">7</td>
                            <td class="px-3 py-2 text-center font-semibold text-red-400 bg-red-50">12</td>
                            <td class="px-3 py-2 text-center text-gray-600 border-l border-gray-100">18</td>
                            <td class="px-3 py-2 text-center text-gray-600">27</td>
                            <td class="px-3 py-2 text-center font-semibold text-orange-400 bg-orange-50">45</td>
                            <td class="px-3 py-2 text-center text-gray-600 border-l border-gray-100">3</td>
                            <td class="px-3 py-2 text-center text-gray-600">4</td>
                            <td class="px-3 py-2 text-center font-semibold text-purple-400 bg-purple-50">7</td>
                            <td class="px-3 py-2 text-center border-l border-gray-100">
                        ...
                        <tr class="bg-gray-50 font-semibold border-t-2 border-gray-200 total-row">
                            ...
                            <td class="px-3 py-2 text-center text-gray-700 border-l border-gray-100">73</td>
                            <td class="px-3 py-2 text-center text-gray-700">111</td>
                            <td class="px-3 py-2 text-center font-bold text-teal-600 bg-teal-100">184</td>
                            <td class="px-3 py-2 text-center font-bold text-pink-500 border-l border-gray-100">285</td>
                            <td class="px-3 py-2 text-center font-bold text-green-500">394</td>
                            <td class="px-3 py-2 text-center text-gray-700 border-l border-gray-100">61</td>
                            <td class="px-3 py-2 text-center text-gray-700">94</td>
                            <td class="px-3 py-2 text-center font-bold text-cyan-500 bg-cyan-100">155</td>
                            <td class="px-3 py-2 text-center text-gray-700 border-l border-gray-100">49</td>
                            <td class="px-3 py-2 text-center text-gray-700">76</td>
                            <td class="px-3 py-2 text-center font-bold text-green-500 bg-green-100">125</td>
                            <td class="px-3 py-2 text-center text-gray-700 border-l border-gray-100">12</td>
                            <td class="px-3 py-2 text-center text-gray-700">18</td>
                            <td class="px-3 py-2 text-center font-bold text-red-400 bg-red-100">30</td>
                            <td class="px-3 py-2 text-center text-gray-700 border-l border-gray-100">41</td>
                            <td class="px-3 py-2 text-center text-gray-700">65</td>
                            <td class="px-3 py-2 text-center font-bold text-orange-400 bg-orange-100">106</td>
                            <td class="px-3 py-2 text-center text-gray-700 border-l border-gray-100">8</td>
                            <td class="px-3 py-2 text-center text-gray-700">11</td>
                            <td class="px-3 py-2 text-center font-bold text-purple-400 bg-purple-100">19</td>
...
function toggleEditMode(rowId) {
    ...
    // 20 data cells (skip first=month, last=actions)
