...
<main id="mainContent" class="flex-1 md:ml-56 min-h-screen">
    ...
    <div class="px-6 md:px-8 py-2 pb-8">
        ...
        <!-- ===== SUMMARY CARDS ===== -->
        <!-- Row 1: Pipeline funnel metrics (from table columns) -->
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-xs" id="wiTable">
                    ...
                    <tbody>
                        ...
                        <!-- Row 1 -->
                        <tr class="border-b border-gray-50 hover:bg-gray-50" data-school="digos city national high school" data-type="shs">
                            <td class="px-3 py-3 text-gray-700 font-medium">January</td>
                            <td class="px-3 py-3 text-gray-700">Digos City National High School</td>
                            <td class="px-3 py-3">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-700">SHS</span>
                            </td>
                            <td class="px-3 py-3 text-gray-600">STEM</td>
                            <td class="px-3 py-3 text-gray-600">PESO Digos City Office</td>
                            <td class="px-3 py-3 text-center text-gray-700 font-medium">240</td>
                            <!-- Participants -->
                            ...
                            <!-- Inquired -->
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">12</td><td class="px-2 py-3 text-center text-gray-600">18</td><td class="px-2 py-3 text-center font-semibold text-blue-500 bg-blue-50">30</td>
                            <!-- Referred -->
                            ...
                            <!-- Privately-Accepted -->
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">1</td><td class="px-2 py-3 text-center text-gray-600">2</td><td class="px-2 py-3 text-center font-semibold text-green-500 bg-green-50">3</td>
                            <!-- Not Proceeded -->
                        ...
                        <tr class="border-b border-gray-50 hover:bg-gray-50" data-school="holy cross of davao college" data-type="college">
                            ...
                            <td class="px-3 py-3 text-center text-gray-700 font-medium">320</td>
                            ...
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">4</td><td class="px-2 py-3 text-center text-gray-600">6</td><td class="px-2 py-3 text-center font-semibold text-orange-500 bg-orange-50">10</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">1</td><td class="px-2 py-3 text-center text-gray-600">3</td><td class="px-2 py-3 text-center font-semibold text-green-500 bg-green-50">4</td>
                        ...
                        <tr class="border-b border-gray-50 hover:bg-gray-50" data-school="davao del sur state college" data-type="college">
                            <td class="px-3 py-3 text-gray-700 font-medium">February</td>
                            ...
                            <td class="px-3 py-3 text-center text-gray-700 font-medium">240</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">12</td><td class="px-2 py-3 text-center text-gray-600">16</td><td class="px-2 py-3 text-center font-semibold text-teal-600 bg-teal-50">28</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">15</td><td class="px-2 py-3 text-center text-gray-600">20</td><td class="px-2 py-3 text-center font-semibold text-blue-500 bg-blue-50">35</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">12</td><td class="px-2 py-3 text-center text-gray-600">16</td><td class="px-2 py-3 text-center font-semibold text-violet-500 bg-violet-50">28</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">10</td><td class="px-2 py-3 text-center text-gray-600">14</td><td class="px-2 py-3 text-center font-semibold text-amber-500 bg-amber-50">24</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">6</td><td class="px-2 py-3 text-center text-gray-600">9</td><td class="px-2 py-3 text-center font-semibold text-orange-500 bg-orange-50">15</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">3</td><td class="px-2 py-3 text-center text-gray-600">4</td><td class="px-2 py-3 text-center font-semibold text-green-500 bg-green-50">7</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">1</td><td class="px-2 py-3 text-center text-gray-600">2</td><td class="px-2 py-3 text-center font-semibold text-red-400 bg-red-50">3</td>
                            <td class="px-3 py-3 text-center border-l border-gray-100">
                        ...
                        <!-- Row 4 -->
                        <tr class="border-b border-gray-50 hover:bg-gray-50" data-school="sta. cruz national high school" data-type="shs">
                            <td class="px-3 py-3 text-gray-700 font-medium">February</td>
                            <td class="px-3 py-3 text-gray-700">Sta. Cruz National High School</td>
                            <td class="px-3 py-3">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-700">SHS</span>
                            </td>
                            <td class="px-3 py-3 text-gray-600">HUMSS</td>
                            <td class="px-3 py-3 text-gray-600">PESO Sta. Cruz</td>
                            <td class="px-3 py-3 text-center text-gray-700 font-medium">160</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">6</td><td class="px-2 py-3 text-center text-gray-600">10</td><td class="px-2 py-3 text-center font-semibold text-teal-600 bg-teal-50">16</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">8</td><td class="px-2 py-3 text-center text-gray-600">12</td><td class="px-2 py-3 text-center font-semibold text-blue-500 bg-blue-50">20</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">6</td><td class="px-2 py-3 text-center text-gray-600">10</td><td class="px-2 py-3 text-center font-semibold text-violet-500 bg-violet-50">16</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">5</td><td class="px-2 py-3 text-center text-gray-600">8</td><td class="px-2 py-3 text-center font-semibold text-amber-500 bg-amber-50">13</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">3</td><td class="px-2 py-3 text-center text-gray-600">5</td><td class="px-2 py-3 text-center font-semibold text-orange-500 bg-orange-50">8</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">1</td><td class="px-2 py-3 text-center text-gray-600">2</td><td class="px-2 py-3 text-center font-semibold text-green-500 bg-green-50">3</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">1</td><td class="px-2 py-3 text-center text-gray-600">1</td><td class="px-2 py-3 text-center font-semibold text-red-400 bg-red-50">2</td>
                            <td class="px-3 py-3 text-center border-l border-gray-100">
                        ...
                        <!-- Row 5 -->
                        <tr class="border-b border-gray-50 hover:bg-gray-50" data-school="mati national comprehensive high school" data-type="shs">
                            <td class="px-3 py-3 text-gray-700 font-medium">March</td>
                            <td class="px-3 py-3 text-gray-700">Mati National Comprehensive High School</td>
                            <td class="px-3 py-3">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-700">SHS</span>
                            </td>
                            <td class="px-3 py-3 text-gray-600">ABM</td>
                            <td class="px-3 py-3 text-gray-600">PESO Mati City</td>
                            <td class="px-3 py-3 text-center text-gray-700 font-medium">240</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">14</td><td class="px-2 py-3 text-center text-gray-600">18</td><td class="px-2 py-3 text-center font-semibold text-teal-600 bg-teal-50">32</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">18</td><td class="px-2 py-3 text-center text-gray-600">22</td><td class="px-2 py-3 text-center font-semibold text-blue-500 bg-blue-50">40</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">14</td><td class="px-2 py-3 text-center text-gray-600">18</td><td class="px-2 py-3 text-center font-semibold text-violet-500 bg-violet-50">32</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">12</td><td class="px-2 py-3 text-center text-gray-600">16</td><td class="px-2 py-3 text-center font-semibold text-amber-500 bg-amber-50">28</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">7</td><td class="px-2 py-3 text-center text-gray-600">10</td><td class="px-2 py-3 text-center font-semibold text-orange-500 bg-orange-50">17</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">3</td><td class="px-2 py-3 text-center text-gray-600">5</td><td class="px-2 py-3 text-center font-semibold text-green-500 bg-green-50">8</td>
                        ...
                        <tr class="border-b border-gray-50 hover:bg-gray-50" data-school="university of southeastern philippines" data-type="college">
                            ...
                            <td class="px-3 py-3 text-gray-600">PESO Davao City</td>
                            <td class="px-3 py-3 text-center text-gray-700 font-medium">320</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">18</td><td class="px-2 py-3 text-center text-gray-600">12</td><td class="px-2 py-3 text-center font-semibold text-teal-600 bg-teal-50">30</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">22</td><td class="px-2 py-3 text-center text-gray-600">15</td><td class="px-2 py-3 text-center font-semibold text-blue-500 bg-blue-50">37</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">18</td><td class="px-2 py-3 text-center text-gray-600">12</td><td class="px-2 py-3 text-center font-semibold text-violet-500 bg-violet-50">30</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">15</td><td class="px-2 py-3 text-center text-gray-600">10</td><td class="px-2 py-3 text-center font-semibold text-amber-500 bg-amber-50">25</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">8</td><td class="px-2 py-3 text-center text-gray-600">5</td><td class="px-2 py-3 text-center font-semibold text-orange-500 bg-orange-50">13</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">3</td><td class="px-2 py-3 text-center text-gray-600">4</td><td class="px-2 py-3 text-center font-semibold text-green-500 bg-green-50">7</td>
                            <td class="px-2 py-3 text-center text-gray-600 border-l border-gray-100">2</td><td class="px-2 py-3 text-center text-gray-600">2</td><td class="px-2 py-3 text-center font-semibold text-red-400 bg-red-50">4</td>
                            <td class="px-3 py-3 text-center border-l border-gray-100">
                        ...
                        <tr class="bg-gray-50 font-semibold border-t-2 border-gray-200 total-row">
                            ...
                            <!-- Inquired -->
                            <td class="px-2 py-3 text-center text-gray-700 border-l border-gray-100">85</td><td class="px-2 py-3 text-center text-gray-700">102</td><td class="px-2 py-3 text-center font-bold text-blue-500 bg-blue-100">187</td>
                            <!-- Referred -->
                            <td class="px-2 py-3 text-center text-gray-700 border-l border-gray-100">68</td><td class="px-2 py-3 text-center text-gray-700">83</td><td class="px-2 py-3 text-center font-bold text-violet-500 bg-violet-100">151</td>
                            <!-- Interviewed -->
                            <td class="px-2 py-3 text-center text-gray-700 border-l border-gray-100">56</td><td class="px-2 py-3 text-center text-gray-700">70</td><td class="px-2 py-3 text-center font-bold text-amber-500 bg-amber-100">126</td>
                            <!-- PESO-Accepted -->
                            <td class="px-2 py-3 text-center text-gray-700 border-l border-gray-100">33</td><td class="px-2 py-3 text-center text-gray-700">43</td><td class="px-2 py-3 text-center font-bold text-orange-500 bg-orange-100">76</td>
                            <!-- Privately-Accepted -->
                            <td class="px-2 py-3 text-center text-gray-700 border-l border-gray-100">15</td><td class="px-2 py-3 text-center text-gray-700">20</td><td class="px-2 py-3 text-center font-bold text-green-500 bg-green-100">35</td>
                            <!-- Not Proceeded -->
                            <td class="px-2 py-3 text-center text-gray-700 border-l border-gray-100">8</td><td class="px-2 py-3 text-center text-gray-700">7</td><td class="px-2 py-3 text-center font-bold text-red-400 bg-red-100">15</td>
...
function getAllDataRows() {
    return Array.from(document.querySelectorAll('#wiTable tbody tr:not(.total-row)'));
}
...
function toggleEditMode(rowId) {
    ...
    // Editable: numeric cells only — skip first 6 info cols and last actions col
