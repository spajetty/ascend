...
async function loadData(year) {
    ...
    try {
        ...
        try {
            ...
            console.warn('[CDSP] cache read failed:', cacheErr);
        }
        ...
        console.log('[CDSP] cache refresh count:', cache_refresh_count ?? 0);
        console.log('[CDSP] cache refreshed at:', cache_refreshed_at ?? '');
